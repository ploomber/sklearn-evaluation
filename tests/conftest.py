...
def roc_multi_classification_values():
    ...
    avg_fpr = np.array([0.0, 0.0, 0.0, 0.0125, 0.0125, 0.0375, 0.0375, 0.0625, 0.0625, 0.075, 0.075,
                        0.0875, 0.0875, 0.125, 0.125, 0.15, 0.15, 0.2125, 0.2125, 0.35,
                        0.35, 0.6, 0.6, 1.0])
    avg_tpr = np.array([0.0, 0.05, 0.35, 0.35, 0.4, 0.4, 0.5, 0.5, 0.55, 0.55, 0.6, 0.6,
