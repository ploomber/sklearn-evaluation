...
"""
    ...
    assert out.to_dict() == {
        "path": {0: "nb-0.ipynb", 1: "nb-1.ipynb"},
        "number": {0: 1, 1: 2},
        "list": {0: "[1,2,3]", 1: "[3,2,1]"},
    }
...
"""
    ...
    assert out.to_dict() == {
        "path": {0: "nb-0.ipynb", 1: "nb-1.ipynb", 2: "nb-2.ipynb"},
        "number": {0: 1, 1: 2, 2: 3},
        "list": {0: "[1,2,3]", 1: "[3,2,1]", 2: "[1,1,1]"},
    }
...
"""
    ...
    assert db._get_paths() == {"nb.ipynb", str(Path("path/to/nb2.ipynb"))}
