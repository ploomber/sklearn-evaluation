...
grid_search(clf.cv_results_, to_vary)
plt.show()
# you can also use bars
grid_search(clf.cv_results_, to_vary, kind='bar')
plt.show()
...
grid_search(clf.cv_results_, to_vary, to_keep, kind='bar')
plt.show()
...
grid_search(clf.cv_results_, to_vary, to_keep)
plt.show()
